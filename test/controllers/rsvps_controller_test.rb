...
class RsvpsControllerTest < ActionController::TestCase
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post :create, rsvp: { coming: @rsvp.coming, count: @rsvp.count, family: @rsvp.family, message: @rsvp.message, song: @rsvp.song }
    end
  ...
  test "should update rsvp" do
    patch :update, id: @rsvp, rsvp: { coming: @rsvp.coming, count: @rsvp.count, family: @rsvp.family, message: @rsvp.message, song: @rsvp.song }
    assert_redirected_to rsvp_path(assigns(:rsvp))
  end
